...
from basicsr.archs.idynamic import IDynamicDWConv
import numbers
...
class vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU_oneOutput(nn.Module):
    def __init__(self, scale_fact):
        super(vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU_oneOutput, self).__init__()
    ...
    def forward(self, x):
        ...
        return x_scale1_out[:, :, :H_in, :W_in]

if __name__ == '__main__':
    model = vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU_oneOutput(0.75).cuda()
