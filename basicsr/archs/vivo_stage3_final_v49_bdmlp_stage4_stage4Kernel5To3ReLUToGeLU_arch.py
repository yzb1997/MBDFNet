...
class vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU(nn.Module):
    def __init__(self, scale_fact):
        super(vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU, self).__init__()
...
if __name__ == '__main__':
    model = vivo_stage3_final_v49_bdmlp_stage4_stage4Kernel5To3ReLUToGeLU(0.75).cuda()
