...
class vivo_stage3_final_v49_stage4ks5To3(nn.Module):
    def __init__(self, scale_fact):
        super(vivo_stage3_final_v49_stage4ks5To3, self).__init__()
...
if __name__ == '__main__':
    model = vivo_stage3_final_v49_stage4ks5To3(0.75).cuda()
